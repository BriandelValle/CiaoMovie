export default class Display {
  ...
  displayDefaultCards() {
    ...
    let moviesType = this.moviesInfo[3];
    let moviesPlot = this.moviesInfo[4];
    ...
    this.container.forEach((row, i) => {
      ...
      imgArray[i].forEach((movie, i) => {
        ...
        this.card.children[1].children[1].innerText = moviesYear[i];
        this.card.children[1].children[2].innerText = moviesType[i];
        this.card.children[1].children[3].innerText = moviesPlot[i];
